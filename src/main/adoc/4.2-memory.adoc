...
in Chrome: +
>> Developer Tools >> *Performance >> {boxtimes} Memory* >> (Record button)
...
in Chrome: +
>> Developer Tools >> Memory >> Profiles >> *{circleDot} Take Heap Snapshot* >> (Record button)
...
in Chrome: +
>> Developer Tools >> Memory >> Profiles >> *{circleDot} Record Allocation Timeline* >> (Record button)
...
in Chrome: +
>> Developer Tools >> Memory >> Profiles >> *{circleDot} Record Allocation Profile* >> (Record button)
