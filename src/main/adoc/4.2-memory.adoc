...
* <<_exercises_detached_nodes,Exercises>>
...
in Chrome: +
>> Developer Tools >> *Timeline >> {boxtimes} Memory* >> (Record button)
...
in Chrome: +
>> Developer Tools >> Profiles >> *{circleDot} Take Heap Snapshot* >> (Record button)
...
in Chrome: +
>> Developer Tools >> Profiles >> *{circleDot} Record Allocation Timeline* >> (Record button)
...
in Chrome: +
>> Developer Tools >> Profiles >> *{circleDot} Record Allocation Profile* >> (Record button)
...
* Select snapshot 3
* Select "Summary" mode
* Then, "Objects allocated between Snapshot 1 and Snapshot" instead of "All objects"
